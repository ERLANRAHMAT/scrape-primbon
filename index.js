...
class Primbon {
    ...
    #generateRandomUserAgent() {
        const iosVersions = ['14.0', '14.1', '14.2', '15.0', '15.1', '15.2', '16.0', '16.1'];
        ...
        return `Mozilla/5.0 (iPhone; CPU iPhone OS ${iosVersion} like Mac OS X) AppleWebKit/${safariVersion} (KHTML, like Gecko) Version/14.0 Mobile/15E148 Safari/${safariVersion}`;
    }
    ...
    async nomer_hoki(nomor) {
        try {
            const response = await fetch(`${this.base_url}no_hoki_bagua_shuzi.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "nomer": nomor, "submit": " Submit! " })
            });
                ...
                hasil = {
                    ...
                    message: {
                        ...
                        energi_negatif: {
                            ...
                            kehancuran: fetchText.split('Kehancuran = ')[1].split('= ')[1].split('\n')[0]
                        },
    ...
    async tafsir_mimpi(value) {
        try {
            const response = await fetch(`${this.base_url}tafsir_mimpi.php?mimpi=${value}&submit=+Submit+`, {
                method: 'GET',
                headers: this.#getHeaders()
            });
    ...
    async ramalan_jodoh(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2) {
        try {
            const response = await fetch(`${this.base_url}ramalan_jodoh.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "nama1": nama1, "tgl1": tgl1, "bln1": bln1, "thn1": thn1, "nama2": nama2, "tgl2": tgl2, "bln2": bln2, "thn2": thn2, "submit": "  RAMALAN JODOH »  " })
            });
    ...
    async ramalan_jodoh_bali(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2) {
        try {
            const response = await fetch(`${this.base_url}ramalan_jodoh_bali.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "nama1": nama1, "tgl1": tgl1, "bln1": bln1, "thn1": thn1, "nama2": nama2, "tgl2": tgl2, "bln2": bln2, "thn2": thn2, "submit": " Submit! " })
            });
    ...
    async suami_istri(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2) {
        try {
            const response = await fetch(`${this.base_url}suami_istri.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "nama1": nama1, "tgl1": tgl1, "bln1": bln1, "thn1": thn1, "nama2": nama2, "tgl2": tgl2, "bln2": bln2, "thn2": thn2, "submit": " Submit! " })
            });
    ...
    async ramalan_cinta(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2) {
        try {
            const response = await fetch(`${this.base_url}ramalan_cinta.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "nama1": nama1, "tanggal1": tgl1, "bulan1": bln1, "tahun1": thn1, "nama2": nama2, "tanggal2": tgl2, "bulan2": bln2, "tahun2": thn2, "submit": " Submit! " })
            });
    ...
    async arti_nama(value) {
        try {
            const response = await fetch(`${this.base_url}arti_nama.php?nama1=${value}&proses=+Submit%21+`, {
                method: 'GET',
                headers: this.#getHeaders()
            });
    ...
    async kecocokan_nama(nama, tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}kecocokan_nama.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "nama": nama, "tgl": tgl, "bln": bln, "thn": thn, "kirim": " Submit! " })
            });
    ...
    async kecocokan_nama_pasangan(nama1, nama2) {
        try {
            const response = await fetch(`${this.base_url}kecocokan_nama_pasangan.php?nama1=${nama1}&nama2=${nama2}&proses=+Submit%21+`, {
                method: 'GET',
                headers: this.#getHeaders()
            });
    ...
    async tanggal_jadian_pernikahan(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}tanggal_jadian_pernikahan.php?tgl=${tgl}&bln=${bln}&thn=${thn}&proses=+Submit%21+`, {
                method: 'GET',
                headers: this.#getHeaders()
            });
    ...
    async sifat_usaha_bisnis(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}sifat_usaha_bisnis.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tgl": tgl, "bln": bln, "thn": thn, "submit": " Submit! " })
            });
    ...
    async rejeki_hoki_weton(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}rejeki_hoki_weton.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tgl": tgl, "bln": bln, "thn": thn, "submit": " Submit! " })
            });
    ...
    async pekerjaan_weton_lahir(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}pekerjaan_weton_lahir.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tgl": tgl, "bln": bln, "thn": thn, "submit": " Submit! " })
            });
    ...
    async ramalan_nasib(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}ramalan_nasib.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tanggal": tgl, "bulan": bln, "tahun": thn, "hitung": " Submit! " })
            });
    ...
    async cek_potensi_penyakit(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}cek_potensi_penyakit.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tanggal": tgl, "bulan": bln, "tahun": thn, "hitung": " Submit! " })
            });
    ...
    async arti_kartu_tarot(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}arti_kartu_tarot.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tgl": tgl, "bln": bln, "thn": thn, "kirim": " Submit! " })
            });
    ...
    async perhitungan_feng_shui(nama, gender, tahun) {
         ...
         */
        try {
            const response = await fetch(`${this.base_url}perhitungan_feng_shui.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "nama": nama, "gender": gender, "tahun": tahun, "submit": " Submit! " })
            });
    ...
    async petung_hari_baik(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}petung_hari_baik.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tgl": tgl, "bln": bln, "thn": thn, "submit": " Submit! " })
            });
    ...
    async hari_sangar_taliwangke(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}hari_sangar_taliwangke.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tgl": tgl, "bln": bln, "thn": thn, "kirim": " Submit! " })
            });
    ...
    async primbon_hari_naas(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}primbon_hari_naas.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tgl": tgl, "bln": bln, "thn": thn, "submit": " Submit! " })
            });
    ...
    async rahasia_naga_hari(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}rahasia_naga_hari.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tgl": tgl, "bln": bln, "thn": thn, "submit": " Submit! " })
            });
    ...
    async primbon_arah_rejeki(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}primbon_arah_rejeki.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tgl": tgl, "bln": bln, "thn": thn, "submit": " Submit! " })
            });
    ...
    async ramalan_peruntungan(nama, tgl, bln, thn, untuk) {
        try {
            const response = await fetch(`${this.base_url}ramalan_peruntungan.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "nama1": nama, "tgl1": tgl, "bln1": bln, "thn1": thn, "thn2": untuk, "submit": " Submit! " })
            });
    ...
    async weton_jawa(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}weton_jawa.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tgl": tgl, "bln": bln, "thn": thn, "submit": "  WETON JAWA »  " })
            });
    ...
    async sifat_karakter_tanggal_lahir(nama, tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}sifat_karakter_tanggal_lahir.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "nama": nama, "tanggal": tgl, "bulan": bln, "tahun": thn, "submit": " Submit! " })
            });
    ...
    async potensi_keberuntungan(nama, tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}potensi_keberuntungan.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "nama": nama, "tanggal": tgl, "bulan": bln, "tahun": thn, "submit": " Submit! " })
            });
    ...
    async primbon_memancing_ikan(tgl, bln, thn) {
        try {
            const response = await fetch(`${this.base_url}primbon_memancing_ikan.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "tgl": tgl, "bln": bln, "thn": thn, "submit": " Submit! " })
            });
    ...
    async masa_subur(dateday, datemonth, dateyear, siklus = "28") {
        try {
            const response = await fetch(`${this.base_url}masa_subur.php`, {
                method: 'POST',
                headers: this.#getHeaders(),
                body: new URLSearchParams({ "dateday": dateday, "datemonth": datemonth, "dateyear": dateyear, "days": siklus, "calculator_ok": " Submit " })
            });
    ...
    async zodiak(zodiak) {
        try {
            const response = await fetch(`https://primbon.com/zodiak/${zodiak}.htm`, {
                method: 'GET',
                headers: this.#getHeaders()
            });
    ...
    async shio(shio) {
        try {
            const response = await fetch(`https://primbon.com/shio/${shio}.htm`, {
                method: 'GET',
                headers: this.#getHeaders()
            });
